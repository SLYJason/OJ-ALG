...
public class Solution {
    public List<List<String>> findLadders(String beginWord, String endWord, List<String> wordList) {
        ...
        Set<String> dict = new HashSet<>(wordList); // convert wordList to Set.
        List<List<String>> res = new ArrayList<>();
        Map<String, List<String>> graph = new HashMap<>();
        Map<String, Integer> distance = new HashMap<>();

        buildGraph(beginWord, endWord, dict, graph, distance); // building an undirected graph.
        dfs(beginWord, endWord, new ArrayList<>(), graph, distance, res);
        return res;
    }
    ...
    private void buildGraph(String beginWord, String endWord, Set<String> dict, Map<String, List<String>> graph, Map<String, Integer> distance) {
        dict.add(beginWord);
        for (String str : dict) graph.put(str, new ArrayList<>()); // nodeNeighbors initialization.
